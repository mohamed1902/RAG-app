...
from .schemes.nlp import PushRequset , SearchRequest
...
async def index_project(request: Request, project_id: str, push_request: PushRequset):
    ...
    nlp_controller = NLPController(
        vector_client=request.app.vectordb_client,
